...
def seed_users():
    demo = User(username='demo-user', name='Demo User', email='demoUser@gmail.com', password='password', isBunny=True, bio='Demo User', address='demo street, demo city, DM 12345')
